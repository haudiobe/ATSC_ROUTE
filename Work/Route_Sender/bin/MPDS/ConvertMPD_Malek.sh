...
cd /root/Documents/mad_fcl_v1.7_linux_bin_Malek/
./start_broadcast_service.sh -P server_files/1b_1M_test -p 4000 -D 224.1.1.1 -r 1000000 -v $interval_video -a $interval_audio -L ${info[0]:7:-1} -l ${info[3]:7:-1}
