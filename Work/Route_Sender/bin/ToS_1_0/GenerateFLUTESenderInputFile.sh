...
videoSegmentIdentifier=video_8M_*		#Used to ignore video segments when processing audio segments
AudioSegmentIdentifier=audio_64k_*		#Used to ignore video segments when processing audio segments
