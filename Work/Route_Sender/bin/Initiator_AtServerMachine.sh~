...
(cd $FLUTEReceiver && ./flute -A -B:$DASHContent -d:$sdp -v:4 -Y:$encodingSymbolsPerPacket -J:$Log&)
(cd $FLUTEReceiver && ./flute -A -B:$DASHContent -d:$sdp2 -Y:$encodingSymbolsPerPacket -J:$Log2&)
