...
#Define Paths
Client=http://10.4.127.99
DASHContent=/home/elkhatib/Documents/Test/FLUTE/Video_Test
FLUTEReceiver=/home/elkhatib/Malek/FLUTE/mad_fcl_v1.7_linux_bin_Malek/bin
#FLUTESender=root@10.4.127.99:/home/elkhatib/Malek/FLUTE/mad_fcl_v1.7_src_ModifySending/mad_fcl_v1.7_linux_bin_Malek/bin
FLUTESender=/home/elkhatib/Malek/FLUTE/mad_fcl_v1.7_src_ModifySending/mad_fcl_v1.7_linux_bin_Malek/bin
#USDFiles=1b_1M_test/\{MultiRate_Dynamic.mpd,BBB_720_1M_video_init.mp4,BBB_32k_init.mp4,../SDP.sdp,../SDP2.sdp\}
RefClient=$Client/dash.js-development_Original/UptoDate_WithMetrics_WithSourceBuffer/dash.js/?mpd=$Client/Test/FLUTE/Video_Test/MultiRate_Dynamic.mpd
HTMLLocalStorage="/home/elkhatib/.config/google-chrome-unstable/Default/Local Storage/"
...
cp 1b_1M_test/MultiRate_Dynamic.mpd $DASHContent
cp 1b_1M_test/BBB_720_1M_video_init.mp4 $DASHContent
cp 1b_1M_test/BBB_32k_init.mp4 $DASHContent
...
(cd $FLUTEReceiver && ./flute -A -B:$DASHContent -Q -d:$sdp -v:4 -Y:$encodingSymbolsPerPacket -J:$Log&)
(cd $FLUTEReceiver && ./flute -A -B:$DASHContent -Q -d:$sdp2 -Y:$encodingSymbolsPerPacket -J:$Log2&)
...
cp $FLUTESender/$SenderLog $LogsFolder
