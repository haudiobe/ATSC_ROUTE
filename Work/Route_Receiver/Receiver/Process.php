...
$cmd=  "sudo nice --20 /data/local/tmp/flute -A -B:". $DASHContent ." -d:" . $sdp . " -Q -Y:" . $encodingSymbolsPerPacket . " -J:" . $Log . " > /dev/null &"; //> logout1.txt &";
exec($cmd);

# Start second flute sender
$cmd=  "sudo nice --20 /data/local/tmp/flute -A -B:". $DASHContent ." -d:" . $sdp2 . " -Q -Y:" . $encodingSymbolsPerPacket . " -J:" . $Log . " > /dev/null &"; // > logout2.txt &";
exec($cmd);
