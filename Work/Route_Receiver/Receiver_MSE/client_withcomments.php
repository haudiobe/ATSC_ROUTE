...
function callback(e)
{
        ...
        websocket.onopen = function () {
			websocket.send("video"); // This triggers the websocket.onmessage function with the video message.
        };
        ...
        websocketAudio.onopen = function () {
			websocketAudio.send("audio"); // This triggers the websocket.onmessage function with the audio message.
        };
